      ...
      <main className="Autor-main">
        ...
        <article className="derecha">
          ...
          <aside className="izquierda">
            <p>
              Aqui va mas que todo texto de ejemplo de lo que es esta pagina es
              una pagina dedicada pura y duramente para comprar Hamburgesas y
              comidas de la gastronomia humana, donde aunque parezcna grandes
              tiene unos alimentos expisitos, que cualquier Elite quedaria
              encatado
            </p>
          </aside>
        </article>
